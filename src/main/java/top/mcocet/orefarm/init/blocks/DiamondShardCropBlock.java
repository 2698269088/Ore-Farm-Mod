...
public class DiamondShardCropBlock extends BlockCrops {
    public DiamondShardCropBlock(String name) {
        this.setUnlocalizedName(name);
        this.setRegistryName(name);
    }

    protected Item getSeed() {
        return ItemInit.diamond_shard_seed;
    }

    protected Item getCrop() {
        return ItemInit.diamond_shard;
    }
